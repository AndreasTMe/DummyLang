...
public sealed class CharacterLiteralExpression : PositionedNode, IExpression, ITypeExpression
{
    ...
    public TokenPosition Start => _start ??= CharacterToken.Position;
    public TokenPosition End   => _end ??= CharacterToken.Position;
